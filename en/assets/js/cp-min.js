...
! function (e) {
    ...
    i.prototype = {
        ...
        keydown: function (t) {
            ...
            if (t.keyCode == 40 && f < s.length - 1) f++;
            if (!~f) f = 0;
            s.eq(f).focus()
        }
    };
...
! function (e) {
    ...
    t.prototype = {
        ...
        activate: function (t, n, r) {
            ...
            o ? s.one(e.support.transition.end, i) : i();
            s.removeClass("in")
        }
    };
    var n = e.fn.tab;
...
! function (e) {
    ...
    t.prototype = {
        ...
        reset: function (e) {
            ...
            this.$element.removeClass("collapse")[t](e || "100%")[0].offsetWidth;
...
$(document).scroll(function () {
    var e = $(".subnav");
    if (!e.attr("data-top")) {
        if (e.hasClass("navbar-fixed-top")) return;
      var t = e.offset();
        e.attr("data-top", t.top)
    }
    if (e.attr("data-top") - e.outerHeight() <= $(this).scrollTop()) e.addClass("navbar-fixed-top");
    else e.removeClass("navbar-fixed-top")
});
...
$(".subnav ul li a").bind("click", function (e) {
    e.preventDefault();
    $("html, body").animate({
        scrollTop: $(this.hash).offset().top
    }, 300)
});
$(".how").bind("click", function (e) {
    e.preventDefault();
    $("html, body").animate({
        scrollTop: $(this.hash).offset().top
    }, 300)
...
$(function () {
    ...
    $(document).ajaxStart(function () {
        if (e.length === 0) {
            e = $("<div><dt/><dd/></div>").attr("id", "progress");
            $("body").append(e)
        }
        e.width(50 + Math.random() * 30 + "%")
    });
    $(document).ajaxComplete(function () {
        e.width("100%").delay(200).fadeOut(400, function () {
            e.width("0%").delay(200).show()
        })
    });
    $("#btn-ss2").on("click", function () {
...
$(window).scroll(function () {
    ...
    if (e > 700) {
        $(".subnav").addClass("showit");
        $(".navbar-inverse").addClass("menuN")
    } else {
        $(".subnav").removeClass("showit");
        $(".navbar-inverse").removeClass("menuN")
    }
})
